...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall()
    {
        ...
        // Should be uncommented at first installation to delete old plugin fragments if old version (non-encapsulated) was installed. After that, it is better to comment it out.
